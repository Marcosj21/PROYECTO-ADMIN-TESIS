    ...
    return (
      <div className="p-4 md:p-8">
        ...
        <select
          ...
          className="px-4 py-2 rounded-xl bg-[#1A1A1A] border border-white/10 focus:border-yellow-400 outline-none text-white mb-6"
        >
        ...
        {cargandoSes ? (
          ...
          <div className="bg-[#1A1A1A] rounded-2xl border border-white/10 overflow-x-auto">
            ...
            {filtradas.length === 0 && <div className="text-center text-gray-500 py-12">No hay sesiones</div>}
          </div>
        )}
